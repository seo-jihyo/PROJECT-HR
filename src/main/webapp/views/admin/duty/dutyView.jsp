	...
	<div class="navbar_1" id="navbar">
		<nav class="nav">
			<div>
				...
				<div href="#" class="nav_link collapse">
					<i class='nav_icon bx bxs-plane-alt'></i></i> <span class="nav_name">휴
						가</span> <i class='collapse_link bx bxs-chevron-down arrow'></i>
				...
				<div href="#" class="nav_link collapse">
					<i class='nav_icon bx bxs-report'></i></i> <span class="nav_name">관
						리</span> <i class='collapse_link bx bxs-chevron-down arrow'></i>
